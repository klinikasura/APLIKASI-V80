...
<meta http-equiv="refresh" content="1000000000000000000000000000000;url=http://192.168.88.203/dashboard/APPS-ROBOT/GITHUB/LOGIN-V80/"/>  
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="http://192.168.88.203/dashboard/APPS-ROBOT/GITHUB/index-dashboard.php"><img src="ICON-V80/download.jpeg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="http://192.168.88.203/dashboard/APPS-ROBOT/GITHUB/index-dashboard.php"><img src="ICON-V80/download.jpeg" alt="logo"/></a>
      </div>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
             ...
             <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h3 class="font-weight-bold ">SUPER HERO</h3>
                <h6 class="font-weight-normal mb-0">V.80 <span class="text-primary"></span></h6>
...
z-index:10000;
            ...
            <div class="container">
              <div class="card tale-bg"
                <div class="">
                  <img src="ICON-V80/ROBOT-VERSI-80.gif" alt="people">
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        ...
                        <h4 class="location font-weight-normal">AI Robot System</h4>
                        <h6 class="font-weight-normal">(Development)</h6>
