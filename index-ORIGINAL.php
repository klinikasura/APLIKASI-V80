...
?>
    ...
    <!-- Footer Area -->
            ...
            <h1><div class="footer-bottom text-center">
                <ul>
                    <li>
                        <a href="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/index-dashboard2.php">
<img border="0" src="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/FILE/BERANDA.png"  height="45" width="45" /></a>
                            <i class=""></i>
                            <p>Beranda</p>
                        </a>
                    </li>
                    <li>
                        <a href="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/index-dashboard-2-2.html">
<img border="0" src="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/FILE/SATUSEHAT-INTEGRASI-VERSI-80-2.png"  height="50" width="50" /></a>
                            <i class=""></i>
                            <p>ASKES</p>
                        </a>
                    </li>
                    <li>
                        <a href="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/index-dashboard-3-3.html">
<img border="0" src="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/FILE/EMONEY.png"  height="45" width="45" /></a>
                            <i class=""></i>
                            <p>E-MONEY</p>
                        </a>
                    </li>
                    <li>
                        <a href="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/index-dashboard-Playstore.html">
<img border="0" src="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/FILE/PLAYSTORE.png"  height="45" width="45" /></a>
                            <i class=""></i>
                            <p>PLAYSTORE</p>
                        </a>
                    </li>
                    <li>
                        <a href="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/logout2.php">
<img border="0" src="http://10.10.20.253/dashboard/APPS-ROBOT/GITHUB/FILE/LOGOUT.png"  height="45" width="45" /></a>
                            <i class=""></i>
                            <p>LOGOUT</p>
                        </a>
                    </li>
