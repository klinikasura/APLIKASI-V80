<p>
        <div id="post">
            <h5 class="title">::[ Input Presensi Pegawai (foto diambil saat memilih shift) ]::</h1>
            <div class="entry">
              ...
              <tr class='head'>
                ...
                <td width=50%>
                      <table width="100%" align="center">
                          ...
                          <tr class="head4">
                              <td width="31%" >NIP / No. Kartu</td><td width="">:</td>
                              <td width="67%"><input name="barcode" class="text7" onkeydown="setDefault(this, document.getElementById('MsgIsi3'));" type=text id="TxtIsi3" class="inputbox" value="" size="8" maxlength="70"/>
